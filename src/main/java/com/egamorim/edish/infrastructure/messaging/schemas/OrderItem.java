...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3442169993927804945L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.egamorim.edish.infrastructure.messaging.schemas\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"int\"}]}");
   ...
   */
  public OrderItem(java.lang.CharSequence id, java.lang.Integer amount) {
    this.id = id;
    this.amount = amount;
  }
   ...
   */
  public static com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder newBuilder() {
    return new com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder newBuilder(com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder other) {
    return new com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder(other);
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder newBuilder(com.egamorim.edish.infrastructure.messaging.schemas.OrderItem other) {
    return new com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.egamorim.edish.infrastructure.messaging.schemas.OrderItem other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder setAmount(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.egamorim.edish.infrastructure.messaging.schemas.OrderItem.Builder clearAmount() {
